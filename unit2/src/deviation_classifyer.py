...
#First we can conder the dataset
...
plt.scatter(deviation_ok.iloc[:, 0], deviation_ok.iloc[:, 1], s=10, label='OK')
plt.scatter(deviation_not.iloc[:, 0], deviation_not.iloc[:, 1], s=10, label='Fail')
